...
def resnet_block(x, filters, kernel_size=(3, 3)):
    ...
    x = Conv2D(filters, kernel_size, padding="same", kernel_initializer="he_uniform")(x)
...
def flor(input_size, d_model):
    ...
    cnn = PReLU(shared_axes=[1, 2])(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
    cnn = resnet_block(cnn, filters=64)     
...
def cvi(input_size, d_model):
   
    input_data = Input(name="input", shape=input_size)

    cnn = Conv2D(filters=64, kernel_size=(3, 3), strides=(1, 1), padding="same", kernel_initializer="he_uniform")(input_data)
    cnn = PReLU(shared_axes=[1, 2])(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
    
    cnn = MaxPooling2D(pool_size=(2,2), strides=(1, 1), padding="valid")(cnn)
    k=cnn
    cnn = Conv2D(filters=64, kernel_size=(3, 3), strides=(1, 1), padding="same", kernel_initializer="he_uniform")(input_data)
    cnn = PReLU(shared_axes=[1, 2])(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
    ...
    cnn = Conv2D(filters=128, kernel_size=(3, 3), strides=(1, 1), padding="same", kernel_initializer="he_uniform")(input_data)
    cnn = PReLU(shared_axes=[1, 2])(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
    cnn=k+cnn
    k=cnn
    ...
    cnn = Conv2D(filters=256, kernel_size=(3, 3), strides=(1, 1), padding="same", kernel_initializer="he_uniform")(input_data)
    cnn = PReLU(shared_axes=[1, 2])(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
    cnn=k+cnn
    k=cnn
    ...
    cnn=k+cnn
    k=cnn
    cnn = MaxPooling2D(pool_size=(2,1), strides=(1, 1), padding="valid")(cnn)
    
    cnn = Conv2D(filters=512, kernel_size=(3, 3), strides=(1, 1), padding="same", kernel_initializer="he_uniform")(input_data)
    cnn = PReLU(shared_axes=[1, 2])(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
    cnn=k+cnn
    k=cnn
